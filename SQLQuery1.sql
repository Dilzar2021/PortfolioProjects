...
Select Location, date, Convert (int,total_cases), Convert(int,total_deaths), (Convert(int,total_deaths)/Convert(int,total_cases))*100 as DeathPercentage
...
Select Location, date, Population, Convert (int,total_cases),  (Convert (int,total_cases) / population)*100 as PercentPopulationInfected
From ProtfolioProject..CovidDeaths
--Where location like '%states%'
order by 1,2
